//
//  ESUIBaseNavigationController.m
//  iosproject
//
...
#import "ESUIBaseNavigationController.h"
#import "ESUICategories.h"
#import "ESUICore.h"

@interface ESUIBaseNavigationController ()
@property (nonatomic, weak) UIViewController *viewControllerPopping;
@end

@implementation ESUIBaseNavigationController
...
- (NSArray<UIViewController *> *)popToRootViewControllerAnimated:(BOOL)animated {
    if (self.topViewController == self.esui_rootViewController) {
        return nil;
    }
...
- (UIViewController *)childViewControllerForStatusBarHidden {
    return [self childViewControllerForStatusBarWithCustomBlock:^BOOL(UIViewController *vc) {
        return vc.esui_prefersStatusBarHiddenBlock || [vc esui_hasOverrideUIKitMethod:@selector(prefersStatusBarHidden)];
    }];
}

- (UIViewController *)childViewControllerForStatusBarStyle {
    return [self childViewControllerForStatusBarWithCustomBlock:^BOOL(UIViewController *vc) {
        return vc.esui_preferredStatusBarStyleBlock || [vc esui_hasOverrideUIKitMethod:@selector(preferredStatusBarStyle)];
    }];
}
...
- (BOOL)shouldAutorotate {
    if ([self.visibleViewController esui_hasOverrideUIKitMethod:_cmd]) {
