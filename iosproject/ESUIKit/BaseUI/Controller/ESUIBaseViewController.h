...
@protocol ESUIViewControllerTransitionAppearanceDelegate <ESUINavigationBarTransitionDelegate, ESUINavigationBarAppearanceDelegate>

@end

@interface ESUIBaseViewController : UIViewController <ESUIViewControllerTransitionAppearanceDelegate>
...
@interface ESUIBaseViewController (UISubclassingHooks)
