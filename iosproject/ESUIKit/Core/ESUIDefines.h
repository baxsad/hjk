...
#define IS_IPAD [ESUIHelper isIPad]
#define IS_IPHONE [ESUIHelper isIPhone]
#define IS_SIMULATOR [ESUIHelper isSimulator]

#define IOS_DEVICE_MODEL [ESUIHelper deviceModel]
#define IOS_DEVICE_NAME  [ESUIHelper deviceName]
#define IOS_VERSION [ESUIHelper iosVersion]
#define IOS_VERSION_NUMBER [ESUIHelper numberiOSVersion]

#define IS_LANDSCAPE [ESUIHelper isLandscape]
#define IS_DEVICE_LANDSCAPE [ESUIHelper isDeviceLandscape]
#define IS_ZOOMEDMODE [ESUIHelper isZoomedMode]
#define IS_NOTCHED_SCREEN [ESUIHelper isNotchedScreen]
#define IS_REGULAR_SCREEN [ESUIHelper isRegularScreen]
