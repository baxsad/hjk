...
#import "HJKRouterDelegate.h"
#import "HJKRouterCommon.h"

NS_ASSUME_NONNULL_BEGIN

@protocol HJKRouterProtocol <NSObject>
...
/// @param factory 回调方法
- (void)register:(NSString *)pattern factory:(HJKRouterViewControllerFactory)factory;

/// 注册路由事件
/// @param pattern 路由地址格式
/// @param factory 回调方法
- (void)handle:(NSString *)pattern factory:(HJKRouterURLOpenHandlerFactory)factory;
